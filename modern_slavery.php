...
// Page title
$page_title = "ANU Hospitality Staff Ltd - Modern Slavery Statement";
...
<main>
  ...
  <section class="modern-slavery-section">
    <div class="container">
      <h1 class="section-title">Modern Slavery Act 2015 Statement</h1>
      ...
      <ul class="policy-list">
        <li>Identify and assess potential risk areas in our workforce.</li>
        <li>Mitigate the risk of slavery and human trafficking in our workforce.</li>
        <li>Work with our supply chains to identify and assess potential risk areas.</li>
        <li>Mitigate the risk of slavery and human trafficking in our supply chains.</li>
